...
<div class="tr">⚠️ <b>ट्रैप:</b> भारत का पहला super computer <b>PARAM</b> (माइक्रो/मिनी नहीं); भारत का पहला micro <b>Siddhartha</b>; पहला mini <b>PDP-8</b>। इन तीनों को घुमाकर पूछा जाता है।</div>
</div>
...
<div class="blk"><h3>7️⃣ Input Devices — विस्तार से</h3>
<div style="overflow-x:auto"><table>
<tr><th>यंत्र</th><th>पूरा नाम / काम</th><th>ख़ास</th></tr>
<tr><td><b>Keyboard</b></td><td>text/command इनपुट; QWERTY layout</td><td>101/104 कुंजियाँ</td></tr>
<tr><td><b>Mouse</b></td><td>pointing device</td><td>Douglas Engelbart</td></tr>
<tr><td><b>MICR</b></td><td>Magnetic Ink Character Recognition</td><td>⭐ <b>बैंक चेक</b> पढ़ना</td></tr>
<tr><td><b>OMR</b></td><td>Optical Mark Reader</td><td>OMR शीट के गोले</td></tr>
<tr><td><b>OCR</b></td><td>Optical Character Recognition</td><td>छपे अक्षर → text</td></tr>
<tr><td><b>BCR</b></td><td>Bar Code Reader</td><td>दुकान की पट्टियाँ</td></tr>
<tr><td>Scanner, Joystick, Light Pen, Web-cam, Mic, Touch screen</td><td>अन्य आम input</td><td>Touch screen = I/O दोनों</td></tr>
</table></div>
<div class="tr">⚠️ <b>PYQ (Q34):</b> "बैंक में चेक की भारी मात्रा" → <b>MICR</b>। मंत्र: <b>"चेक = MICR"</b>। OMR गोले, OCR अक्षर, BCR बार कोड।</div>
</div>
...
<div class="blk"><h3>1️⃣1️⃣ Codes — डेटा का प्रतिनिधित्व</h3>
<div style="overflow-x:auto"><table>
<tr><th>Code</th><th>पूरा नाम</th><th>bits</th><th>ख़ास</th></tr>
<tr><td><b>ASCII</b></td><td>American Standard Code for Information Interchange</td><td>7 (extended 8)</td><td>128/256 अक्षर; A=65, a=97, 0=48</td></tr>
<tr><td><b>EBCDIC</b></td><td>Extended Binary Coded Decimal Interchange Code</td><td>8</td><td>IBM mainframe में</td></tr>
<tr><td><b>BCD</b></td><td>Binary Coded Decimal</td><td>4</td><td>हर decimal अंक अलग</td></tr>
<tr><td><b>Unicode</b></td><td>Universal code</td><td>16+</td><td>दुनिया की हर भाषा (हिन्दी भी)</td></tr>
<tr><td><b>Gray code</b></td><td>—</td><td>—</td><td>एक बार में सिर्फ़ 1 bit बदले</td></tr>
</table></div>
<div class="tk">🧠 <b>ASCII के पक्के मान:</b> 'A' = 65, 'a' = 97 (फ़र्क़ 32), '0' = 48, space = 32, Enter = 13। EBCDIC सिर्फ़ IBM mainframe (PYQ में इसी का ज़िक्र)।</div>
</div>
